...
// Headline metric. Big typography, count-up on scroll.
export const METRICS = [
  { to: 77000, suffix: "+", label: "video creations on one sound, for a single client" },
];
...
export const CASE_STUDY = {
  ...
  question:
    "How did one sound generate over 77,000 video creations for a single client?",
