...
export const SERVICES = [
  {
    ...
    desc: "The network that puts your music in front of the right communities and lets the scene do the sharing. Not posting, but engineering the conditions for a record to spread.",
  },
  {
...
// Featured proof, the one number, posed as an invitation. Curiosity, not the
// full method.
export const CASE_STUDY = {
  kicker: "Field Report No. 001",
  question:
    "How did we generate over 77,000 video creations for a single client?",
  cta: "Get in touch",
};
